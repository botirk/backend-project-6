...
test.sequential('post user & edit user', async () => {
  ...
  edit = await inject({
    method: 'POST', url: paths.editDeleteUser(1),
    payload: { data: { firstName: 'changedUser', lastName: 'changedUser', email: 'changedEmail', password: 'changedUser' } },
  })
  expect(edit.statusCode).toBe(302)
  ...
  edit = await inject({
    method: 'POST', url: paths.editDeleteUser(2),
    payload: { data: { firstName: 'changedUser', lastName: 'changedUser', email: 'changedEmail', password: 'changedUser' } },
  })
  expect(edit.statusCode).toBe(302)
...
test.sequential('post user & delete user', async () => {
  ...
  del = await inject({
    method: 'POST', url: paths.editDeleteUser(3),
